...
namespace LevelUp.CsharpJuniors.Tasks.Lesson4.Reflection;

public sealed class ReflectionExamples
{
    public void DealWithTypeInfo(Type type)
    {           
