...
namespace LevelUp.CsharpJuniors.Tasks.Lesson4.Generics;

public sealed class GenericsExamples
{
    public void DealWithGenerics()
    {
    ...
    private static void DealWithNonGenericCollections()
    {
    ...
    private static void DealWithGenericCollections()
    {
    ...
    private static void DealWithSerialization()
    {
